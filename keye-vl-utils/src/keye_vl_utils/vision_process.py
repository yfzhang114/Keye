...
FORCE_KEYEVL_VIDEO_READER = os.getenv("FORCE_KEYEVL_VIDEO_READER", None)


@lru_cache(maxsize=1)
def get_video_reader_backend() -> str:
    if FORCE_KEYEVL_VIDEO_READER is not None:
        video_reader_backend = FORCE_KEYEVL_VIDEO_READER
    ...
    print(f"keye-vl-utils using {video_reader_backend} to read video.", file=sys.stderr)
